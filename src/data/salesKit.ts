...
export const offerPackages: OfferPackage[] = [
  {
    ...
    price: '¥99',
    badge: '最容易成交',
    summary: '把现有职业闯关互动页换成对方品牌，适合先拿第一单。',
    deliverables: [
      '替换 Logo、标题、主视觉文案',
      '保留职业选择 + 闯关体验 + 学习资源结构',
      '交付 H5 静态演示包或在线预览链接',
...
export const outreachTargets: OutreachTarget[] = [
  ...
  },
  {
    ...
    pitch: '用闯关互动页展示职业方向、课程路线和学习资源，比传统长图更容易让用户停留。',
  },
  {
    title: '个人博主或知识付费创作者',
    painPoint: '只有图文内容，缺少能转发和互动的轻量产品。',
    pitch: '这套互动页可以快速换皮成你的职业测试或学习路线页，拿来做引流很合适。',
  },
];
...
export const copyTemplates: CopyTemplate[] = [
  {
    ...
    content:
      '我这边做了一个“职业方向闯关小游戏”互动页，可以快速改成你的品牌版，适合就业指导、训练营招生、社群拉新。\n\n现阶段提供 99 元验证版：当天换 Logo、标题、主文案，保留职业选择、闯关、学习资源展示，直接给你 H5 预览链接。\n\n如果你有课程、活动、社群，也可以做 299 元活动版，把职业方向、题库、课程链接替换成你的内容。想看效果我可以直接发预览。',
  },
  {
    id: 'dm',
    title: '私聊开场话术',
    ...
    content:
      '你好，我最近做了一个适合就业指导/课程招生的互动小游戏页面。不是普通海报页，而是用户可以选职业方向、做闯关、看学习路线的 H5。\n\n如果你最近有活动、招生、社群拉新，我可以先做一个 99 元验证版给你看效果，当天能交。要不要我把预览链接和可改内容发你？',
  },
  {
    id: 'followup',
    title: '跟进成交话术',
